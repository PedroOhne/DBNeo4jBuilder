 ...
 * @author maestro
 */
public class CanadaSuperInstanz_F {
    ...
    static String[] report = {"primaryid", "caseid", "caseversion", "i_f_code", "mfr_dt",
        ...
        "rept_dt", "to_mfr", "occp_cod", "reporter_country", "occr_country", "unique_source"};
    ...
    public CanadaSuperInstanz_F(HashMap<Integer, String[]> canadian_prop_map, GraphDatabaseService db_s) {
